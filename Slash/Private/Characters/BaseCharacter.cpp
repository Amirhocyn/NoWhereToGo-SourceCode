...
#include "Characters/SlashAnimStance.h"
...
void ABaseCharacter::DirectionalHitReact(const FVector& ImpactPoint)
{
	...
	// Forward * TOHit = |Forward||ToHIt| * cos(Tetha)
	// |Forward| = 1 |ToHit| = 1, so Forward * ToHit = cos(tetha)
...
FVector ABaseCharacter::GetRoationWarpTarget()
{
	if (CombatTarget)
	{
